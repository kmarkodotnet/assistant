...
/// AsNoTracking(), and the various *Async() operators via the EF Core async provider bridge.
/// Mirrors FamilyOs.Infrastructure.Tests.Common.MockDbSet (duplicated rather than shared —
/// Application.Tests does not reference the Infrastructure.Tests test project).
/// </summary>
